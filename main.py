...
def start(update, context):
    ...
    context.bot.send_message(update.effective_chat.id, 'Меня зовут БОТ БЫК, а тебя?')
    return PLAYER
...
def take_move(update, context):
    ...
    try:
        ...
        context.bot.send_message(update.effective_chat.id, f'Введи четырехзначное число...')
        return MOVE
